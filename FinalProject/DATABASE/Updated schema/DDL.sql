...
CREATE TABLE maeling(
    ID                  INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    orku_ID             INT NOT NULL,    -- sendandi_maelingar 
...
framleiðsla stærri en inmmöttun og 
inmöttun stærri en allar utektir
